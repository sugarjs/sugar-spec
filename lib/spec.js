...
function createMiddleware(cb) {
    sugar.create(models.Middleware, {}, function(err, d) {
        // TODO: figure out how to assert this properly. post gets triggered only after this
        // is finished! also cb of this func is problematic (posthandler gets skipped?)
        assert.ok(d.pre);
        assert.ok(d.post);
